namespace CompilerDestroyer.Editor.FolderIcons
{
    ...
    internal static class ProjectConstants
    {
        ...
        internal static readonly string emptyIconFolderPath = pluginsfolderIconsEditorPath + "/" + EmptyColorFolderIcons;
        internal static readonly string iconFolderPath = pluginsfolderIconsEditorPath + "/" + ColorFolderIcons;
        internal static readonly string loadedIconSetPath = pluginsfolderIconsEditorPath + "/" + LoadedIconSets;
        internal static readonly string loadedIconsPath = pluginsfolderIconsEditorPath + "/" + LoadedIcons;
